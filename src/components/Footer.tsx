      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold text-foreground">Asociación Alzheimer</span>
            </div>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Comprometidos con el apoyo a personas con Alzheimer y sus familias, ofreciendo recursos, 
              cuidado y esperanza cada día.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:info@alzheimer.org" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Mail className="w-4 h-4" />
                <span className="text-sm">info@alzheimer.org</span>
              </a>
              <div className="flex items-start gap-2 text-muted-foreground">
                <MapPin className="w-4 h-4 mt-0.5" />
                <span className="text-sm">Calle Principal 123<br />28001 Madrid, España</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                href="https://www.facebook.com/Balzheime/" 
                target="_blank" 
        ...
        <div className="border-t border-border mt-8 pt-6 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Asociación Alzheimer. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
